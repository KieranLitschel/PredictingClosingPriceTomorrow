...
I tried tweaking the threshold to classify the OBV gradient as flat, trying 0.01 and 0.1, but neither gave much improvement on using a value of 0.05. The final thing I will try is using longer periods for OBV, trying 20, 35, and 50, with a threshold of 0.05. I doubt this will be useful for predicting short term changes in price, but I have read that OBV gives too many false signals for small periods, and I have observed this in the classifications my system is giving. So I'll see if longer periods work any better.
